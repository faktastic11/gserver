...
const insertProcessedTranscript = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    inputStream
        ...
        const newProcessedDoc = yield models_1.ProcessedTranscript.create({
            ...
            metricType: "Guidance",
            valueCategory,
            value: Object.assign(Object.assign(Object.assign(Object.assign({}, (amtLow && { low: { amt: amtLow, unit: unitLow } })), (amtHigh && { high: { amt: amtHigh, unit: unitHigh } })), (amtLow &&
                amtHigh && { mid: { amt: (amtLow + amtHigh) / 2, unit: unitLow } })), (qualitativeLow && { qualitative: low })),
