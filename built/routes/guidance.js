...
const tickerGuidanceValidation = (req, res, next) => {
    const querySchema = joi_1.default.object({
        ...
        fiscalYear: joi_1.default.number(),
        fiscalQuarter: joi_1.default.number(),
        metricType: joi_1.default.string(),
...
const guidanceCompaniesValidation = (req, res, next) => {
    ...
    (0, validators_1.default)(req, res, next, [
        { schema: schema, reqTarget: validators_1.reqTargetTypes.QUERY },
    ]);
};
...
router.get("/v1/guidance/revisions", auth_1.authenticateToken, guidanceRevisionValidation, (req, res, next) => {
    (0, guidance_1.getGuidanceRevisions)(req, res, next).catch((err) => {
        return (0, error_1.logApiError)(req, res, next, err, 500, "Could not get guidance revision for companies");
    });
});
